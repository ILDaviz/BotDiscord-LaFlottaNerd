...
/**
 * Stampa il grado cacciatore
 * @param { livel } Livello del cacciatore
 */
botFunction.getGradoCacciatore = function(livel){
    var name = "";
...
/**
 * La frase contiene una parola non permessa
 * @param str Stringa da analizzare
 */
botFunction.censunre = function(str) {
...
/**
 * Le risposte della palla da otto casulamente.
 */
botFunction.getRispose = function(){
...
/**
 * Processo che resetta la cache dei testi
 */
botFunction.resetCacheText = function(result){
...
/**
 * Seleziona la frase da far usare al bot
 * @param {string} tag il riferimento del tag
 * @param {string} bot il riferimento del bot
 */
botFunction.selectCacheText = function (tag,bot) {
